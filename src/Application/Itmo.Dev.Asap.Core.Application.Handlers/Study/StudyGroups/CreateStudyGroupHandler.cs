...
using MediatR;
using static Itmo.Dev.Asap.Core.Application.Contracts.Study.StudentGroups.Commands.CreateStudentGroup;
...
internal class CreateStudyGroupHandler : IRequestHandler<Command, Response>
{
    ...
    public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
    {
        ...
        var notification = new StudentGroupCreated.Notification(dto);
